  ...
  return (
      <div style={{padding: "20px", maxWidth: "400px", fontFamily: "Arial"}}>
        ...
        <div style={{ marginBottom: '20px' }}>
            ...
            <button onClick={addTask} style={{padding: "8px 15px", cursor: "pointer"}}>Add Todo</button>
        </div>
     
        <ul style={{ listStyle: 'none', padding: 0 }}>
            {todos.map((todo) => (
                <li key={todo.id} style={{display: "flex", alignItems: "center", justifyContent:"space-between", marginBottom:"10px", padding:"10px", border:"2px solid lavenderblush"}}>
